...
```bash
cp -r ui-desgin/claude-opus-5-ui-aesthetics ~/.claude/skills/claude-opus-5-ui-aesthetics
```
...
| 技能 | 风格取向 | 特点 |
|------|----------|------|
| [claude-opus-5-ui-aesthetics](ui-desgin/claude-opus-5-ui-aesthetics/SKILL.md) | 克制、极简、系统化 | 九条铁律 + 四轴人格决策流程 + 可量化的硬数值（对比度/间距/圆角）+ `palette.py` 配色脚本，强调"做减法后仍然清晰" |
| [gemini-3.6-flash-ui-aesthetics](ui-desgin/gemini-3.6-flash-ui-aesthetics/SKILL.md) | 惊艳、质感、暗色科技感 | 核心设计哲学 + 5 步工作流 + Design Tokens 体系 + 组件模板库，覆盖 SaaS / AI Copilot / Dashboard / Landing Page 等场景 |

### 对比与选择

- 想要 **系统化、可量化、克制高级** 的界面 → 选 `claude-opus-5-ui-aesthetics`（风格来源：Claude Opus 5）
- 想要 **视觉惊艳、质感丰富、暗色科技风** 的界面 → 选 `gemini-3.6-flash-ui-aesthetics`（风格来源：Gemini 3.6 Flash）
...
├── README.md
└── ui-desgin/
    ├── gemini-3.6-flash-ui-aesthetics/ # Gemini 3.6 Flash 风格：惊艳质感派
    ...
    └── claude-opus-5-ui-aesthetics/      # Claude Opus 5 风格：系统克制派
        ├── SKILL.md                     # 技能主文件（含 description 触发词）
        ├── references/                  # 深度参考文档
